...
```mermaid
gantt
    title CeloHT Roadmap (2026-2028+)
    dateFormat  YYYY-MM
    axisFormat  %Y-%m

    section Phase 1 - Foundation
    Flagship repository and docs      :done,    p1a, 2026-05, 2026-07
    Core training material (Creole)   :done,    p1b, 2026-05, 2026-07
    First agent cohort (Leogane)      :active,  p1c, 2026-07, 2026-10
    First ecosystem grants            :active,  p1d, 2026-07, 2026-10
    ...
    Multi-department agent expansion  :         p3a, 2027-03, 2027-09
    Spanish translation of curriculum :         p3b, 2027-03, 2027-06
    dApp public beta                  :         p3c, 2027-04, 2027-08
    Caribbean partnership exploration :         p3d, 2027-06, 2027-12

    section Phase 4 - Maturity
    Decentralized governance model    :         p4a, 2028-01, 2028-12
    Self-sustaining agent network     :         p4b, 2028-01, 2028-12
    Recognized certification program  :         p4c, 2028-01, 2028-12
```
...
```mermaid
flowchart LR
    subgraph Public["Official Website - public information"]
    ...
    subgraph Operational["Official CeloHT dApp - operational platform"]
        E[Wallet Connection - Valora]
    ...
    subgraph Pillars["Three Permanent Pillars"]
        I[Education]
        J[Agent Network]
        K[Reforestation]
    end
