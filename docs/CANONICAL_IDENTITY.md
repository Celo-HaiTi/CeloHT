...
This document defines the current and canonical identity for the Celo-HaiTi ecosystem.

- **Current project identity:** `CeloHT`
- **Canonical GitHub organization:** [Celo-HaiTi](https://github.com/Celo-HaiTi)
- **Current canonical organization URL:** https://github.com/Celo-HaiTi
...
Repositories using the `CeloHT` name outside `Celo-HaiTi` must not be treated as official without explicit verification from the organization.
