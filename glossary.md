...
**CELO** - Celo's native token, used for transaction fees and protocol
governance.

**CeloHT** - A community-driven, open-source initiative built on the Celo
...
**FreClean** - The founder's second initiative; a professional cleaning
services business and local entrepreneurship ecosystem.

**Reforestation** - The process of replanting trees in areas affected by
deforestation.
...
not own, manage, or operate it.

**Web3** - A general term referring to a generation of internet technology
built on decentralized infrastructure such as blockchain.
