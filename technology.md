...
The current stable-value asset used by the project for everyday payments and
value transfer on Celo. The historical label "Celo Dollar" may appear in
older material, but the preferred current terminology is USDm.
...
CeloHT's current wallet strategy targets MiniPay, Valora, and
WalletConnect-compatible wallets. No wallet provider is treated as the
project's sole official wallet unless a separate, explicit, verified
